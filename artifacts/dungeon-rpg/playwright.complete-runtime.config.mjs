...
export default defineConfig({
  testDir: './tests',
  testMatch: /(?:complete-runtime-evidence|complete-runtime-room-titles|renderer-recovery-hidden-hud|post-clear-player-hazards|atomic-room-readiness|portrait-orientation|worldboss-block1|full-game-smoke|enemy-registry-codex|enemy-roster-visual-evidence)\.spec\.mjs/,
  timeout: 900_000,
