...
const checks = [
  ...
  [inventory.includes('data-testid="relic-source-summary"') && inventory.includes('Bossräumen 10, 20, 30, 40 und 50') && inventory.includes('ausschließlich vom Weltboss') && !inventory.includes('Bossräume ab Raum 20'), 'relic source explanation does not match all five boss rooms'],
