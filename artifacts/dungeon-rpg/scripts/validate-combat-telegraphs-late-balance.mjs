...
assert(!legacyBalance.includes('Math.min(20, engine.state.floor)'), 'Room 21-70 must not be collapsed into room 20.');
...
console.log('Combat telegraph and centralized room 21-70 balance audit passed.');
