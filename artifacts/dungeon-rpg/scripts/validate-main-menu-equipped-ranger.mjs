...
const checks = [
  ...
  [heroAsset.includes('<svg') && heroAsset.includes('viewBox="0 0 540 960"') && heroAsset.includes('data:image/webp;base64,'), 'approved embedded portrait hero asset is missing or malformed'],
