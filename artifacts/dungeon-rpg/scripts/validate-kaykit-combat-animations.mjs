...
const checks = [
  ...
  [enemy.includes('Rig_Medium_CombatMelee.glb') && enemy.includes('Rig_Medium_CombatRanged.glb'), 'Enemy library does not load both KayKit melee and ranged animation packs'],
