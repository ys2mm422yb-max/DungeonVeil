...
const [panel, card, client, identity] = await Promise.all([
...
console.log('Friends/public-profile audit passed: cosmetic friend and request cards open public profiles, actions stay separate and active runs can be watched.');
