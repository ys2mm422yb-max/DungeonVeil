...
const [migration, noticesMigration, rewardSweepMigration, profileExtensionMigration, attemptMigration, socialClient, friendClient, attemptClient, friendsPanel, guildSocial, profileCard, onlinePanel, bossPanel, mailbox, rewardLocal, tutorial, tutorialState, bridge, menu, villageHub, menuScene, main] = await Promise.all([
...
console.log('Social progression audit passed: friend codes, presence and favorites, extended profile cards, direct guild invites, social mailbox notices and bulk actions, friend/guild world-boss rankings, a server-enforced 24-hour boss attempt gate, participation-gated rewards, the seven-part tutorial and interactive Veil village NPC hub are wired.');
