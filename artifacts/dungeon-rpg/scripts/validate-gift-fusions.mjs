...
const checks = [
  ...
  [skills.includes('Angriffs-Cooldown -16%') && skills.includes('Angriffs-Cooldown -30%') && skills.includes('Angriffs-Cooldown -42%') && skills.includes('Attack cooldown -16%') && skills.includes('Attack cooldown -30%') && skills.includes('Attack cooldown -42%') && !skills.includes('16% schneller') && !skills.includes('16% faster'), 'Quick Draw copy does not describe the authoritative cooldown reduction semantics'],
  [skills.includes('Bis zu 2 Ziele/Pfeile') && skills.includes('Bis zu 4 Ziele/Pfeile') && skills.includes('Up to 2 targets/arrows') && skills.includes('Up to 4 targets/arrows') && !skills.includes('im Fächer') && !skills.includes('in a fan'), 'Multishot copy still describes a fan instead of its authoritative visible-target auto-aim contract'],
  [skills.includes('35% Angriff') && skills.includes('Radius 92') && skills.includes('max. 3 weitere Ziele') && skills.includes('35% attack') && skills.includes('radius 92') && skills.includes('max 3 additional targets'), 'Elemental Storm copy omits its authoritative damage, radius or target cap'],
  [skills.includes('visueller Feuerburst beim Tod') && skills.includes('visual fire burst on death') && !skills.includes('+ Feuerburst beim Tod') && !skills.includes('+ death fire burst'), 'Fire Arrow III copy still implies an unimplemented damaging death burst'],
  [translations.includes("attack: '+4 Attack'") && translations.includes("speed: '+12 Move Speed'") && translations.includes("attack: '+4 Angriff'") && translations.includes("speed: '+12 Bewegung'") && !translations.includes('+5 Attack') && !translations.includes('+15 Move Speed') && !translations.includes('+5 Angriff') && !translations.includes('+15 Bewegung'), 'legacy upgrade summaries drift from the authoritative rank-I attack or movement values'],
