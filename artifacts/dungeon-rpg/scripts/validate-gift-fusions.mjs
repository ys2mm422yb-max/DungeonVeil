...
const checks = [
  ...
  [translations.includes("attack: '+2 Attack'") && translations.includes("speed: '+12 Move Speed'") && translations.includes("attack: '+2 Angriff'") && translations.includes("speed: '+12 Bewegung'") && !translations.includes('+5 Attack') && !translations.includes('+15 Move Speed') && !translations.includes('+5 Angriff') && !translations.includes('+15 Bewegung'), 'legacy upgrade summaries drift from the authoritative rank-I attack or movement values'],
