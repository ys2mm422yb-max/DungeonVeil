...
const checks = [
  ...
  [files.relics.includes('50 % mehr Schleierstaub') && files.relics.includes('50% more Veil Dust') && files.retention.includes("activeRelic === 'night-hunt-sigil' ? 1.5 : 1"), 'Night Hunt relic text and real dust multiplier disagree'],
...
console.log('Dust/avatar overhaul audit passed: migration preserves cloud weight, rewards feed Veil Dust, V4 upgrades consume three resources and all profile avatars use safe vector portraits.');
