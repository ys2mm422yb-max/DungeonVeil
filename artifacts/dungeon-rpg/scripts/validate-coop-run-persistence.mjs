...
const checks = [
  ...
  [migration.includes('coop_room_reward_entitlements_lobby_id_run_attempt_chapter_room_user_id_key') && migration.includes('claimed_at is null'), 'server reward idempotency or pending claim tracking is missing'],
