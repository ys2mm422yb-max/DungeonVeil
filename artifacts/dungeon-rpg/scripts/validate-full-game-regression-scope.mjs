...
const [config, smoke, packageJson, checkWorkflow, ciWorkflow] = await Promise.all([
...
console.log('Full-game regression scope audit passed: all major menu flows, combat startup, cross-device layouts, runtime errors, assets, rooms and build checks are covered.');
