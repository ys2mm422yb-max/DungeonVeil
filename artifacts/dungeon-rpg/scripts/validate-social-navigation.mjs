...
const checks = [
  ...
  [stageWrapper.includes('WorldBossAggressiveStage as WorldBossCohesiveStage') && aggressiveStage.includes('<WorldBossPerspectiveStage') && perspectiveStage.includes("root.name = 'AshKingLowCostKayKitHall'") && perspectiveStage.includes("floor.name = 'AshKingDetailedSingleFloor'") && !perspectiveStage.includes('buildKayKitDungeonRoom'), 'single-floor low-call dragon hall or aggressive controller is missing'],
...
console.log('Social/navigation audit passed: resilient mobile village rendering, stable social routes and aggressive dragon world-boss navigation remain active.');
