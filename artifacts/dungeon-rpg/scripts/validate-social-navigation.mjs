...
const checks = [
  ...
  [villageScene.includes('new ResizeObserver(resize)') && villageScene.includes("window.visualViewport?.addEventListener('resize', resize)") && villageScene.includes("canvas.style.width = '100%'"), 'mobile village viewport or canvas sizing is missing'],
