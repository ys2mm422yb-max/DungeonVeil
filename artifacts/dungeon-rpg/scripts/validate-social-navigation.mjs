...
const checks = [
  ...
  [menuSceneProxy.includes('data-composition="raised-mobile-hero"') && menuSceneProxy.includes("translate3d(0,5%,0) scale(1.2)"), 'mobile Ranger and wolf presentation does not fill the hero area'],
