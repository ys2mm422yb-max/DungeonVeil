...
const checks = [
  ...
  [moreOverlay.length === 0 && !menu.includes('main-menu-resource-popover') && menu.includes('main-menu-shop-panel') && menu.includes('main-menu-options-panel') && menu.includes('main-menu-settings-button'), 'retired more-options routing returned or Shop and Options are not isolated from play modes'],
