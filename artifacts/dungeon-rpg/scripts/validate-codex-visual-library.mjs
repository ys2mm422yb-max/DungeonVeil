...
assert(preview.includes('getSharedRenderer(THREE)') && preview.includes("window.addEventListener('pagehide', releaseSharedRenderer"), 'Codex selections recreate WebGL contexts instead of reusing one page-bounded renderer.');
