...
assert(inventory.includes("const TABS: ChamberTab[] = ['bow', 'quiver', 'armor', 'relic', 'companion']"), 'five-tab equipment contract missing');
assert(inventory.includes("type ChamberTab = EquipmentTab | 'relic' | 'companion'"), 'companion tab is not isolated from active equipment slots');
