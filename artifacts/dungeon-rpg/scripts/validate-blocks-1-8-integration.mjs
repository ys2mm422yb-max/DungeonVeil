...
const checks = [
  ...
  [village.includes('loadKayKitVillageArcher') && villagePlayer.includes("root.name = 'VillageEquippedPlayer'") && villagePlayer.includes('Rogue_Hooded.glb'), 'dedicated equipped village archer is missing'],
...
console.log('Block 8 integration audit passed: the final Blocks 1–7 changes and the dedicated equipped village archer coexist in one clean device-review snapshot.');
