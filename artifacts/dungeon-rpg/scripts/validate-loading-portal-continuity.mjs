...
assert(game.includes("dataset.dungeonVeilActiveRun = '1'") && game.includes('dungeon-veil-run-active-changed'), 'The game page does not expose active-run protection to the version guard.');
...
assert(canvas.includes('data-portal-contract="dungeon-veil-violet-arch-v2"'), 'Portal visual diagnostics are missing from the shared run renderer.');
