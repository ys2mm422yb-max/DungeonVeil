...
const checks = [
  ...
  [files.panel.includes('testId="profile-distinct-equipment-count"') && files.panel.includes('Verschiedene Ausrüstungsteile') && files.panel.includes('activeOwnedEquipmentCount(meta)'), 'distinct owned equipment count is unclear or includes retired equipment'],
