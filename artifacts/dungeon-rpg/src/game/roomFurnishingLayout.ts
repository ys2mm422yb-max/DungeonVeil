...
export const ROOM_FURNISHING: Record<number, RoomFurnishingPiece[]> = {
  ...
  5: [
    ...
    f(`${T}/screwdriver_A_short_color.gltf`, 5.8, -5.25, .2, 1.0), f(`${T}/file.gltf`, 6.45, -5.1, -.2, 1.0),
  ],
  6: [
  ...
  13: [
    f(`${T}/blueprint_stacked.gltf`, -6.3, -5.25, .1, 1.08), f(`${T}/pencil_A_long.gltf`, -5.7, -5.0, -.2, 1.0),
