...
const SETPIECES: Readonly<Record<number, readonly RoomSetpiece[]>> = {
  ...
  72: [column(-7.5, -5.5), column(-7.5, 0), column(-7.5, 5.1), column(7.5, -5.5), column(7.5, 0), column(7.5, 5.1), p(`${D}/chain.gltf`, 0, -0.4, 0, 1.1)],
  ...
  77: [rune(0, -0.3, 1.7), column(-7.5, -4.7), column(7.5, -4.7), column(-7.5, 4.6), column(7.5, 4.6), p(`${H}/bell.gltf`, 0, 4.8, 0, 1.15, [0.9, 0.9])],
