...
export const EQUIPMENT_WEAPON_VISUALS: Partial<Record<EquipmentId, Visual>> = {
  ...
  'rune-quiver': { id: 'rune-quiver', slot: 'quiver', nameDe: 'Runenköcher', nameEn: 'Rune Quiver', pack: 'weapons', assetPath: `${EXTRA_SKELETON}/Skeleton_Quiver.gltf`, unlockRank: 6, accent: '#b184ff', rarity: 'epic', dropSource: 'ritual' },
  ...
  'warden-quiver': { id: 'warden-quiver', slot: 'quiver', nameDe: 'Schleierköcher', nameEn: 'Veil Quiver', pack: 'weapons', assetPath: `${EXTRA_SKELETON}/Skeleton_Quiver.gltf`, unlockRank: 11, accent: '#e6c46d', rarity: 'epic', dropSource: 'ritual' },
};