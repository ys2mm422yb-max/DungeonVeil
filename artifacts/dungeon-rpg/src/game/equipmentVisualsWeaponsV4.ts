...
export const EQUIPMENT_WEAPON_VISUALS: Partial<Record<EquipmentId, Visual>> = {
  ...
  'hunter-bow': { id: 'hunter-bow', slot: 'bow', nameDe: 'Bogen des Jägers', nameEn: "Hunter's Bow", pack: 'weapons', assetPath: `${WEAPONS}/bow_B_withString.gltf`, unlockRank: 4, accent: '#a8d381', rarity: 'rare', dropSource: 'hunt' },
  ...
  'veil-bow': { id: 'veil-bow', slot: 'bow', nameDe: 'Schleierbogen', nameEn: 'Veil Bow', pack: 'weapons', assetPath: `${WEAPONS}/bow_A.gltf`, unlockRank: 9, accent: '#a88cff', rarity: 'rare', dropSource: 'depth' },
  'warden-bow': { id: 'warden-bow', slot: 'bow', nameDe: 'Wächterbogen', nameEn: 'Warden Bow', pack: 'weapons', assetPath: `${WEAPONS}/bow_B.gltf`, unlockRank: 18, accent: '#f1c66c', rarity: 'epic', dropSource: 'warden' },
