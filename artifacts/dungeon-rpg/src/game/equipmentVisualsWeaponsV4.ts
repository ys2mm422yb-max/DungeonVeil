...
export const EQUIPMENT_WEAPON_VISUALS: Partial<Record<EquipmentId, Visual>> = {
  ...
  'black-quiver': { id: 'black-quiver', slot: 'quiver', nameDe: 'Schnellzugköcher', nameEn: 'Quickdraw Quiver', pack: 'adventurers', assetPath: `${ADVENTURER}/quiver.gltf`, unlockRank: 5, accent: '#8b78ba', rarity: 'rare', dropSource: 'forge' },
  'rune-quiver': { id: 'rune-quiver', slot: 'quiver', nameDe: 'Runenköcher', nameEn: 'Rune Quiver', pack: 'skeletons-extra', assetPath: `${EXTRA_SKELETON}/Skeleton_Quiver.gltf`, unlockRank: 6, accent: '#b184ff', rarity: 'epic', dropSource: 'ritual' },
  'frost-quiver': { id: 'frost-quiver', slot: 'quiver', nameDe: 'Frostköcher', nameEn: 'Frost Quiver', pack: 'adventurers', assetPath: `${ADVENTURER}/quiver.gltf`, unlockRank: 4, accent: '#6fd8ff', rarity: 'rare', dropSource: 'depth' },
  'splinter-quiver': { id: 'splinter-quiver', slot: 'quiver', nameDe: 'Splitterköcher', nameEn: 'Splinter Quiver', pack: 'adventurers', assetPath: `${ADVENTURER}/quiver.gltf`, unlockRank: 6, accent: '#d8bd82', rarity: 'rare', dropSource: 'forge' },
  'warden-quiver': { id: 'warden-quiver', slot: 'quiver', nameDe: 'Schleierköcher', nameEn: 'Veil Quiver', pack: 'skeletons-extra', assetPath: `${EXTRA_SKELETON}/Skeleton_Quiver.gltf`, unlockRank: 11, accent: '#e6c46d', rarity: 'epic', dropSource: 'ritual' },
};