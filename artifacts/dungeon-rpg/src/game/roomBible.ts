...
export const ROOM_BIBLE: Record<number, RoomBibleSpec> = {
  ...
  9: room(9, 'Ritualkammer', 'Ritual Chamber', 'abandoned-quarters', 'ring', 'zentraler Runenkreis', ['halloween', 'resources'], ['candle', 'crystal', 'skull', 'cauldron', 'rune'], ['table', 'barrel', 'shelf', 'bed'], 3, 'abandoned', P(0, -1.0), [P(-4.5, -4.0), P(0, -5.5), P(4.5, -4.0), P(-5.2, 1.2), P(5.2, 1.2), P(-3.5, 5.0), P(3.5, 5.0)]),
