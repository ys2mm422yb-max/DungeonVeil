...
export const CHAPTER_ROOMS = 70;
export const MID_CHAPTER_BOSS_ROOM = 10;
export const FINAL_BOSS_ROOM = 70;
export const BOSS_ROOMS = [10, 20, 30, 40, 50, 60, 70] as const;
...
export function generateRunRoom(room: number): DungeonMap {
  ...
  const authoredExit = observatoryPortalTile(room, width, height)
