...
const GOLDEN_FRACTURE_SETPIECES: Readonly<Record<number, readonly GoldenFractureSetpiece[]>> = {
  ...
  57: [pillar(-6.8, -4.8, 1.3), pillar(0, -5.8, 1.3), pillar(6.8, -4.8, 1.3), pillar(-5.8, 4.5, 1.2), pillar(5.8, 4.5, 1.2), p(`${D}/chest_gold.gltf`, 0, -1.4, Math.PI, 1.1, [1.3, 0.85]), crystal(-7.2, 0.5), crystal(7.2, 0.5)],
