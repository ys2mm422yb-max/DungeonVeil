...
export const KAYKIT_ROOM_PROPS: Record<number, KayKitRoomPlacement[]> = {
  1: [
    { asset: 'crates', x: -8.6, z: -9.8 },
    { asset: 'barrelStack', x: -7.1, z: -8.3 },
    { asset: 'barrelDecorated', x: 8.7, z: -9.5 },
    { asset: 'boxLarge', x: 7.2, z: -7.9 },
    { asset: 'swordShield', x: LEFT_WALL, z: -3.2, rotation: Math.PI / 2 },
    { asset: 'swordShield', x: RIGHT_WALL, z: -3.2, rotation: -Math.PI / 2 },
    { asset: 'torchMounted', x: LEFT_WALL, z: 4.5, rotation: Math.PI / 2 },
    { asset: 'torchMounted', x: RIGHT_WALL, z: 4.5, rotation: -Math.PI / 2 },
    { asset: 'chest', x: 8.2, z: 9.5, rotation: Math.PI },
  ],
  2: [
    { asset: 'column', x: -6.8, z: -8.2 },
    { asset: 'column', x: 6.8, z: -8.2 },
    { asset: 'column', x: -6.8, z: 4.0 },
    { asset: 'column', x: 6.8, z: 4.0 },
    { asset: 'wallShelves', x: LEFT_WALL, z: -4.5, rotation: Math.PI / 2 },
    { asset: 'wallShelves', x: RIGHT_WALL, z: -4.5, rotation: -Math.PI / 2 },
    { asset: 'torchMounted', x: LEFT_WALL, z: 5.5, rotation: Math.PI / 2 },
    { asset: 'torchMounted', x: RIGHT_WALL, z: 5.5, rotation: -Math.PI / 2 },
    { asset: 'chest', x: 8.0, z: 10.0, rotation: Math.PI },
  ],
  3: [
    { asset: 'barrel', x: -8.8, z: -9.5 },
    { asset: 'barrel', x: -7.5, z: -8.8 },
    { asset: 'barrelDecorated', x: 8.7, z: -9.3 },
    { asset: 'crates', x: 7.4, z: -7.7 },
    { asset: 'tableMedium', x: -7.6, z: 4.2, rotation: Math.PI / 2 },
    { asset: 'tableMedium', x: 7.6, z: 4.2, rotation: -Math.PI / 2 },
    { asset: 'torchMounted', x: LEFT_WALL, z: 0.5, rotation: Math.PI / 2 },
    { asset: 'torchMounted', x: RIGHT_WALL, z: 0.5, rotation: -Math.PI / 2 },
    { asset: 'chestGold', x: 8.0, z: 10.0, rotation: Math.PI },
  ],
  4: [
    { asset: 'bed', x: -8.8, z: -8.2, rotation: Math.PI / 2 },
    { asset: 'bed', x: 8.8, z: -8.2, rotation: -Math.PI / 2 },
    { asset: 'chair', x: -8.6, z: 3.8, rotation: Math.PI / 2 },
    { asset: 'chair', x: 8.6, z: 3.8, rotation: -Math.PI / 2 },
    { asset: 'tableLong', x: -6.2, z: -12.0, rotation: Math.PI / 2 },
    { asset: 'torchMounted', x: -5.2, z: TOP_WALL, rotation: Math.PI },
    { asset: 'torchMounted', x: 5.2, z: TOP_WALL, rotation: Math.PI },
    { asset: 'chest', x: 8.0, z: 10.0, rotation: Math.PI },
  ],
  5: [
    { asset: 'column', x: -7.2, z: -8.2 },
    { asset: 'column', x: 7.2, z: -8.2 },
    { asset: 'column', x: -7.2, z: 4.5 },
    { asset: 'column', x: 7.2, z: 4.5 },
