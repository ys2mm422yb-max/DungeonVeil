...
const SETPIECES: Readonly<Record<number, readonly RoomSetpiece[]>> = {
  ...
  65: [rune(0, -0.4, 1.6), pillar(-7.3, -0.4, 1.1), pillar(7.3, -0.4, 1.1), pillar(0, -4.8, 1.1), pillar(0, 5.1, 1.1), lens(-5.3, -4.5, 0, 0.9), lens(5.3, 4.1, 0, 0.9)],
  ...
  69: [rune(0, -0.4, 1.75), pillar(-7.4, -4.6, 1.15), pillar(7.4, -4.6, 1.15), pillar(0, 5.2, 1.15), lens(-5.7, 3.7, 0, 1.0), lens(5.7, 3.7, 0, 1.0), candles(-7.0, -5.8, 1.2)],
  70: [rune(0, 1.6, 2.0), pillar(-8.0, -4.5, 1.3), pillar(8.0, -4.5, 1.3), pillar(-8.0, 4.6, 1.3), pillar(8.0, 4.6, 1.3), lens(-5.8, 0.5, 0, 1.15), lens(5.8, 0.5, 0, 1.15), lens(0, 5.6, 0, 1.15), candles(-6.8, -5.5, 1.4)],
};
