...
import { WorldBossRitualHallFrame } from './WorldBossRitualHallFrame';
...
export function WorldBossCombatBandStage({ engineRef, onReady, onLoadError }: Props) {
  ...
  return <div data-testid="worldboss-combat-band" className="pointer-events-none fixed inset-0 overflow-hidden bg-[#151116]">
    ...
    <div className="absolute inset-x-0 bottom-0 z-[2] h-[8vh] bg-gradient-to-t from-[#09070a] via-[#09070a]/20 to-transparent" />
    <span data-testid="ritual-arena-meaning" className="sr-only">Perspektivisches KayKit-Bossheiligtum mit sichtbarem Ritualkern, klaren Kampfflächenrändern, erhöhter Bossplattform, Schleiertor und räumlicher Dungeon-Architektur</span>
  </div>;
}
