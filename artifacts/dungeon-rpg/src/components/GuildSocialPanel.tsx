...
export function GuildSocialPanel({ language }: Props) {
  ...
  return <div data-testid="guild-social-panel" className="relative min-h-0 flex-1">
    <GuildPanelMobile language={language} />
