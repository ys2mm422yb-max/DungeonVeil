        ...
        <div data-testid="relic-library-layout" className="mt-3 grid items-start gap-3 md:grid-cols-[minmax(0,0.86fr)_minmax(0,1.4fr)]">
          <section data-testid="relic-detail-panel" className="rounded-3xl border border-violet-300/25 bg-black/52 p-5 md:sticky md:top-4">
            {activeRelic ? <>
              ...
              <RelicArtwork relicId={activeRelic.id} accent={activeRelic.accent} className="mx-auto mt-6 h-28 w-28 shadow-[0_0_42px_rgba(142,92,255,.14)]" />
            ...
            {Object.values(VEIL_RELICS).map(relic => {
              ...
              >
                ...
                <div className="relative mt-4 flex items-start gap-3">
                  <span data-testid={owned ? undefined : 'relic-locked-silhouette'}><RelicArtwork relicId={relic.id} locked={!owned} accent={relic.accent} className="h-12 w-12 shrink-0" /></span>
