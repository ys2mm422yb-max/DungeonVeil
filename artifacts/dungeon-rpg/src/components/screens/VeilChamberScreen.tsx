...
export function VeilChamberScreen({ onBack }: { onBack: () => void }) {
  ...
  const relicSourceLabel = (source: 'hunt' | 'boss' | 'worldboss', compact = false) => {
    ...
    return de ? (compact ? 'BOSS-DROP' : 'BOSS-RELIKT') : (compact ? 'BOSS DROP' : 'BOSS RELIC');
  };
