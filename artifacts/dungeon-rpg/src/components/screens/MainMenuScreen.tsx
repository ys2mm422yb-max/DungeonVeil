  ...
  return (
    <div className="fixed inset-0 z-50 select-none overflow-hidden bg-[#070706] text-white">
      ...
      <div className="relative flex h-full flex-col px-5 pb-[max(22px,calc(env(safe-area-inset-bottom)+8px))] pt-[max(30px,calc(env(safe-area-inset-top)+8px))]">
        <header className="text-center"><div className="text-[8px] font-black uppercase tracking-[.52em] text-amber-200/48">{veilLabel}</div><h1 className="mx-auto mt-2 max-w-[92vw] font-serif text-[clamp(2.65rem,11.5vw,4.05rem)] font-black leading-[.88] tracking-[.08em] text-[#e4b14e] drop-shadow-[0_8px_30px_rgba(0,0,0,.78)]"><span className="block">DUNGEON</span><span className="mt-1 block">VEIL</span></h1><p className="mt-3 text-[8px] uppercase tracking-[.32em] text-white/34">{t.subtitle}</p></header>
