...
function qaUrl() { const url = new URL(APP_URL); url.searchParams.set('qa', 'profiles'); return url.toString(); }
...
test('own and public profiles use responsive equipment and companion layouts', async ({ page }, testInfo) => {
  ...
  await expect(page.getByTestId('public-player-profile-companion')).toBeVisible();
